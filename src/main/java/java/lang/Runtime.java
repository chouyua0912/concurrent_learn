...
public class Runtime {
     ...
     *
     * <p> The virtual machine's shutdown sequence consists of two phases.  In      分两个阶段
     * the first phase all registered {@link #addShutdownHook shutdown hooks},      阶段1：注册的hook都会被调用，并发且无顺序，直到结束
